...
import com.irontower.gcbdriver.di.component.DaggerKilometerNumberComponent;
...
import com.irontower.gcbdriver.mvp.presenter.KilometerNumberPresenter;
...
public class KilometerNumberFragment extends BaseFragment<KilometerNumberPresenter> implements
    KilometerNumberContract.View, SwipeRefreshLayout.OnRefreshListener {
  ...
  @Inject
  KilomimeterAdapter adapter;

  public static KilometerNumberFragment newInstance() {
    KilometerNumberFragment fragment = new KilometerNumberFragment();
    return fragment;
  }

  @Override
  public void setupFragmentComponent(AppComponent appComponent) {
    DaggerKilometerNumberComponent //如找不到该类,请编译一下项目
        .builder()
        .appComponent(appComponent)
        .kilometerNumberModule(new KilometerNumberModule(this))
        .build()
        .inject(this);
  }
  ...
  public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    view = inflater.inflate(R.layout.fragment_kilometer_number, container, false);
    return view;
  }
  ...
  public void initChartData(List<ChartData> shortData, List<ChartData> longData) {
    ...
    if (lineChart.getData() != null &&
      ...
      set1 = new LineDataSet(shortEntry, "市区公里数");
      ...
      set1.setValueFormatter(new IValueFormatter() {
        ...
        public String getFormattedValue(float value, Entry entry, int dataSetIndex,
          ...
          return value > 0 ? df.format(value) : "0";
        }
      });
...
//      set1.setDrawValues(false);
      ...
      set2 = new LineDataSet(longEntry, "长途公里数");
...
//      set2.setDrawValues(false);
  ...
  public void onResume() {
    ...
    MobclickAgent.onPageStart(
        "KilometerNumberFragment"); //统计页面(仅有Activity的应用中SDK自动调用，不需要单独写。"SplashScreen"为页面名称，可自定义)
  }
  ...
  public void onPause() {
    ...
    MobclickAgent.onPageEnd(
        "KilometerNumberFragment"); // （仅有Activity的应用中SDK自动调用，不需要单独写）保证 onPageEnd 在onPause 之前调用,因为 onPause 中会保存信息。"SplashScreen"为页面名称，可自定义
  }
}
