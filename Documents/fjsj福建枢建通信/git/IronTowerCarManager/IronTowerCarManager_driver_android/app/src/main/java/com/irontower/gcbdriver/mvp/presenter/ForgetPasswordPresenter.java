...
import com.irontower.gcbdriver.mvp.contract.ForgetPasswordContract;
...
public class ForgetPasswordPresenter extends
  ...
  public void getCode(String s, TextView textView) {
    mModel.getSMS(s).subscribeOn(Schedulers.io())
