...
public class WaitingOrderAdapter extends BaseQuickAdapter<Order, BaseViewHolder> {

  public WaitingOrderAdapter(int layoutResId,
  ...
  protected void convert(BaseViewHolder helper, Order item) {
    ...
    helper.addOnClickListener(R.id.layTakeOrder).addOnClickListener(R.id.layCall);
