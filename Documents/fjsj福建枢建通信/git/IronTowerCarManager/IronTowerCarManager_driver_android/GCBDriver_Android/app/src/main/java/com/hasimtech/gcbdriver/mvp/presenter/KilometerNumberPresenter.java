...
@ActivityScope
public class KilometerNumberPresenter extends
    BasePresenter<KilometerNumberContract.Model, KilometerNumberContract.View> {

  private RxErrorHandler mErrorHandler;
  private Application mApplication;
  private Gson mGson;

  private KilomimeterAdapter mAdapter;

  @Inject
  public KilometerNumberPresenter(KilometerNumberContract.Model model,
      KilometerNumberContract.View rootView
      , RxErrorHandler handler, Application application, KilomimeterAdapter adapter, Gson gson) {
