...
import com.irontower.gcbdriver.di.component.DaggerOrderFeeListComponent;
...
import com.irontower.gcbdriver.mvp.presenter.OrderFeeListPresenter;
...
public class OrderFeeListActivity extends BaseActivity<OrderFeeListPresenter> implements
    OrderFeeListContract.View, SwipeRefreshLayout.OnRefreshListener {
  ...
  public void setupActivityComponent(@NonNull AppComponent appComponent) {
    DaggerOrderFeeListComponent //如找不到该类,请编译一下项目
        .builder()
        .appComponent(appComponent)
        .orderFeeListModule(new OrderFeeListModule(this))
        .build()
        .inject(this);
  }
  ...
  public int initView(@Nullable Bundle savedInstanceState) {
    return R.layout.activity_order_fee_list; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
  }
