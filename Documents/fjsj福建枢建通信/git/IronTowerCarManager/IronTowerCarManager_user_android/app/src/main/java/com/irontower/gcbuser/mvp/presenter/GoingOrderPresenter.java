...
@ActivityScope
public class GoingOrderPresenter extends
    BasePresenter<GoingOrderContract.Model, GoingOrderContract.View> {

  private RxErrorHandler mErrorHandler;
  private GoingOrderAdapter mAdapter;
  private int currentPage = 1;
  private int totalNum = 0;
  private Application mApplication;

  @Inject
  public GoingOrderPresenter(GoingOrderContract.Model model, GoingOrderContract.View rootView
      , RxErrorHandler handler, GoingOrderAdapter adapter, Application application) {
