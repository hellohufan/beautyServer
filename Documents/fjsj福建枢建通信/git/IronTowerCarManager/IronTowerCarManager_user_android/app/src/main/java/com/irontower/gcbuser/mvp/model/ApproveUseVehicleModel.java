...
@ActivityScope
public class ApproveUseVehicleModel extends BaseModel implements ApproveUseVehicleContract.Model {

  private Gson mGson;
  private Application mApplication;

  @Inject
  public ApproveUseVehicleModel(IRepositoryManager repositoryManager, Gson gson,
