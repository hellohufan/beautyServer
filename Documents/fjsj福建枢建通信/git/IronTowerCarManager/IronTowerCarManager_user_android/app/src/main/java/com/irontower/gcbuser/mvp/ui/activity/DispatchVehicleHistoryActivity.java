...
import com.irontower.gcbuser.di.component.DaggerDispatchVehicleHistoryComponent;
...
import com.irontower.gcbuser.mvp.presenter.DispatchVehicleHistoryPresenter;
...
public class DispatchVehicleHistoryActivity extends
    BaseActivity<DispatchVehicleHistoryPresenter> implements DispatchVehicleHistoryContract.View,
  ...
  @Inject
  DispatchVehicleHistoryAdapter adapter;
  @Inject
  ...
  public void setupActivityComponent(AppComponent appComponent) {
    DaggerDispatchVehicleHistoryComponent //如找不到该类,请编译一下项目
        .builder()
        .appComponent(appComponent)
        .dispatchVehicleHistoryModule(new DispatchVehicleHistoryModule(this))
        .build()
        .inject(this);
  }
  ...
  public int initView(Bundle savedInstanceState) {
    return R.layout.activity_dispatch_vehicle_history; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
  }
  ...
  public void initData(Bundle savedInstanceState) {
    ...
    adapter.setOnLoadMoreListener(new RequestLoadMoreListener() {
      ...
      public void onLoadMoreRequested() {
        mPresenter.getData(editText.getText().toString(), orderBy, orderCol, beginCreateTime,
            endCreateTime, false, beginTime, endTime);
    ...
    adapter.setOnItemClickListener(new OnItemClickListener() {
      ...
      public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        intent.putExtra("flowId", approveOrder.getFlowId());
        intent.setClass(getActivity(), DispatchCarHistoryDetailActivity.class);
    ...
    switch (view.getId()) {
      case R.id.layCreateTime:
        if ("commitTime".equals(orderCol)) {
          ...
          orderCol = "commitTime";
          orderBy = "desc";
          ivApprovalTime.setVisibility(View.INVISIBLE);
          ivCreateTime.setImageResource(R.mipmap.time_down);

          ivCreateTime.setVisibility(View.VISIBLE);
      ...
      case R.id.layApproveTime:
        if ("dealTime".equals(orderCol)) {
          ...
          orderCol = "dealTime";
          orderBy = "desc";
          ivCreateTime.setVisibility(View.INVISIBLE);
          ivApprovalTime.setVisibility(View.VISIBLE);
          ivApprovalTime.setImageResource(R.mipmap.time_down);
