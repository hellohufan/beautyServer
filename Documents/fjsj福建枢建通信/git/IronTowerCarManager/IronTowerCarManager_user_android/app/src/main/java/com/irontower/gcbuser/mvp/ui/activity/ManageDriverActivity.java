...
import com.irontower.gcbuser.di.component.DaggerManageDriverComponent;
...
import com.irontower.gcbuser.mvp.presenter.ManageDriverPresenter;
...
public class ManageDriverActivity extends BaseActivity<ManageDriverPresenter> implements
    ManageDriverContract.View, SwipeRefreshLayout.OnRefreshListener {
  ...
  public void setupActivityComponent(AppComponent appComponent) {
    DaggerManageDriverComponent //如找不到该类,请编译一下项目
        .builder()
        .appComponent(appComponent)
        .manageDriverModule(new ManageDriverModule(this))
        .build()
        .inject(this);
  }
  ...
  public int initView(Bundle savedInstanceState) {
    return R.layout.activity_manage_driver; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
  }
  ...
  public void initData(Bundle savedInstanceState) {
    ...
    adapter.setOnItemClickListener(new OnItemClickListener() {
      ...
      public void onItemClick(BaseQuickAdapter adapter, android.view.View view, int position) {
        Driver driver = (Driver) adapter.getData().get(position);
