...
import com.irontower.gcbuser.di.component.DaggerDispatchVehicleDetailComponent;
...
import com.irontower.gcbuser.mvp.presenter.DispatchVehicleDetailPresenter;
...
public class DispatchVehicleDetailActivity extends
    BaseActivity<DispatchVehicleDetailPresenter> implements DispatchVehicleDetailContract.View {
  ...
  public void setupActivityComponent(AppComponent appComponent) {
    DaggerDispatchVehicleDetailComponent //如找不到该类,请编译一下项目
        .builder()
        .appComponent(appComponent)
        .dispatchVehicleDetailModule(new DispatchVehicleDetailModule(this))
        .build()
        .inject(this);
  }
  ...
  public int initView(Bundle savedInstanceState) {
    return R.layout.activity_dispatch_vehicle_detail; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
  }
...
//        layAgree.setVisibility(View.GONE);
...
//    if (orderCars.size() == 0 && !dyddy) {

//      layAgree.setVisibility(View.VISIBLE);
...
//    }
  ...
  @OnClick(R.id.layAgree)
  public void onViewClicked2() {
    if (orderCarList.size() == 0) {
      ArmsUtils.makeText(getActivity(), "订单至少要派一辆车才能结束.");
      return;
    }
    new Builder(getActivity())
        .title("提示")
        ...
        .onPositive(new SingleButtonCallback() {
          ...
          public void onClick(@NonNull MaterialDialog dialog,
            ...
            mPresenter.finishDispatchCar(todoId);
          }
        })
        .show()
    ;
