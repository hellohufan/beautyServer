...
public class GoOutRecordAdapter extends BaseQuickAdapter<BegGoOut, BaseViewHolder> {
  ...
  protected void convert(BaseViewHolder helper, BegGoOut item) {
    ...
    helper.setText(R.id.tvRealOutTime, item.getRealOutTime() + " 出场");
  ...
  public GoOutRecordAdapter(int layoutResId,
