 ...
 * ================================================
 */
public interface TraceViewContract {
  ...
  interface View extends IView {
    ...
    void init(List<Track> rows);

    void refreshData(List<CarSearch> carSearches);
  }

  //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
  interface Model extends IModel {

    Observable<BaseRowJson<Track>> getData(String carId, String carNo, CharSequence bTime,
        CharSequence eTime);
  }
}
