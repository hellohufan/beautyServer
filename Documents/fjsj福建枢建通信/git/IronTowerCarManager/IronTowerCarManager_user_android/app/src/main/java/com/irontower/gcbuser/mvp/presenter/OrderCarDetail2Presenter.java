...
@ActivityScope
public class OrderCarDetail2Presenter extends
    BasePresenter<OrderCarDetail2Contract.Model, OrderCarDetail2Contract.View> {
  ...
  @Inject
  public OrderCarDetail2Presenter(OrderCarDetail2Contract.Model model,
      OrderCarDetail2Contract.View rootView
