...
public interface OrderCarContract {
  ...
  interface Model extends IModel {
    ...
    Observable<BaseJson<Map<String, Object>>> submitOrder(SubmitOrder submitOrder,
        List<Attach> attachList);

    Observable<BaseJson<Map<String, Object>>> updateOrder(String orderNo, SubmitOrder submitOrder,
        List<Attach> attachList);
  }
}
