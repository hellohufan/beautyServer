...
import com.irontower.gcbuser.di.component.DaggerOrderCarDetailComponent;
import com.irontower.gcbuser.di.module.OrderCarDetailModule;
import com.irontower.gcbuser.mvp.contract.OrderCarDetailContract.View;
...
import com.irontower.gcbuser.mvp.presenter.OrderCarDetailPresenter;
...
public class OrderCarDetailActivity extends BaseActivity<OrderCarDetailPresenter> implements
    View {
  ...
  public void setupActivityComponent(AppComponent appComponent) {
    DaggerOrderCarDetailComponent //如找不到该类,请编译一下项目
        .builder()
        .appComponent(appComponent)
        .orderCarDetailModule(new OrderCarDetailModule(this))
        .build()
        .inject(this);
  }
  ...
  public int initView(Bundle savedInstanceState) {
    return R.layout.activity_order_car_detail; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
  }
...
//    }
  ...
  @OnClick({R.id.layEvaluate, R.id.layCancel, R.id.layPayBack, R.id.ivCall, R.id.ivPassengerCall,
      R.id.layDriverPosition})
  public void onViewClicked(android.view.View view) {
    switch (view.getId()) {
      ...
      case R.id.layCancel:
        new Builder(this)
            .title("提示")
            .content(orderCar.getState() < 6 ? "确认取消订单吗?" : "行程已开始,取消订单将继续收费!")
            ...
            .onPositive(new SingleButtonCallback() {
              ...
              public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                mPresenter.cancelOrder(orderCar.getOrderCarNo(), "");
