...
import com.irontower.gcbuser.di.component.DaggerUseCarMoneyComponent;
...
import com.irontower.gcbuser.mvp.presenter.UseCarMoneyPresenter;
...
public class UseCarMoneyFragment extends BaseFragment<UseCarMoneyPresenter> implements
    UseCarMoneyContract.View, SwipeRefreshLayout.OnRefreshListener {
  ...
  @Inject
  UseCarMoneyAdapter adapter;


  public static UseCarMoneyFragment newInstance() {
    UseCarMoneyFragment fragment = new UseCarMoneyFragment();
    return fragment;
  }

  @Override
  public void setupFragmentComponent(AppComponent appComponent) {
    DaggerUseCarMoneyComponent //如找不到该类,请编译一下项目
        .builder()
        .appComponent(appComponent)
        .useCarMoneyModule(new UseCarMoneyModule(this))
        .build()
        .inject(this);
  }
  ...
  public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    view = inflater.inflate(R.layout.fragment_use_car_money, container, false);
    return view;
  }
  ...
  public void initChartData(List<ChartData> shortData, List<ChartData> longData) {
    ...
    if (lineChart.getData() != null &&
      ...
      set1 = new LineDataSet(shortEntry, "市区用车费");
...
//      set1.setDrawValues(false);
      ...
      set2 = new LineDataSet(longEntry, "长途用车费");
...
//      set2.setDrawValues(false);
  ...
  public void onResume() {
    ...
    MobclickAgent.onPageStart(
        "UseCarMoneyFragment"); //统计页面(仅有Activity的应用中SDK自动调用，不需要单独写。"SplashScreen"为页面名称，可自定义)
  }
  ...
  public void onPause() {
    ...
    MobclickAgent.onPageEnd(
        "UseCarMoneyFragment"); // （仅有Activity的应用中SDK自动调用，不需要单独写）保证 onPageEnd 在onPause 之前调用,因为 onPause 中会保存信息。"SplashScreen"为页面名称，可自定义
  }
