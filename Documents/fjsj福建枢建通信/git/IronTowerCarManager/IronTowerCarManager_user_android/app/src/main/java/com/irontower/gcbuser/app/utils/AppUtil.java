...
public class AppUtil {
  ...
  public static List<Dict> getCarUses() {
    List<Dict> dictList = new ArrayList<>();
    Gson gson = new Gson();
    if (SPUtils.getInstance().contains("carUses")) {
      for (JsonElement jsonElement : new JsonParser()
          .parse(SPUtils.getInstance().getString("carUses")).getAsJsonArray()) {
  ...
  public static List<String> getCarUses1() {
  ...
  public static List<String> getOrderStates1() {
    List<String> dictList = new ArrayList<>();
    Gson gson = new Gson();
    if (SPUtils.getInstance().contains("orderStates")) {
      for (JsonElement jsonElement : new JsonParser()
          .parse(SPUtils.getInstance().getString("orderStates")).getAsJsonArray()) {
        dictList.add(gson.fromJson(jsonElement, Dict.class).getName());
      }
    }
  ...
  public static List<Dict> getOrderStates() {
    List<Dict> dictList = new ArrayList<>();
    Gson gson = new Gson();
    if (SPUtils.getInstance().contains("orderStates")) {
      for (JsonElement jsonElement : new JsonParser()
  ...
  public static List<String> getDriverStates1() {
    List<String> dictList = new ArrayList<>();
    Gson gson = new Gson();
    if (SPUtils.getInstance().contains("driverStates")) {
      for (JsonElement jsonElement : new JsonParser()
          .parse(SPUtils.getInstance().getString("driverStates")).getAsJsonArray()) {
        dictList.add(gson.fromJson(jsonElement, Dict.class).getName());
      }
    }
  ...
  public static List<Dict> getDriverStates() {
    List<Dict> dictList = new ArrayList<>();
    Gson gson = new Gson();
    if (SPUtils.getInstance().contains("driverStates")) {
      for (JsonElement jsonElement : new JsonParser()
  ...
  public static List<String> getCarUseStates1() {
    List<String> dictList = new ArrayList<>();
    Gson gson = new Gson();
    if (SPUtils.getInstance().contains("carUseStates")) {
      for (JsonElement jsonElement : new JsonParser()
          .parse(SPUtils.getInstance().getString("carUseStates")).getAsJsonArray()) {
        dictList.add(gson.fromJson(jsonElement, Dict.class).getName());
      }
    }
  ...
  public static List<Dict> getCarUseStates() {
    List<Dict> dictList = new ArrayList<>();
    Gson gson = new Gson();
    if (SPUtils.getInstance().contains("carUseStates")) {
      for (JsonElement jsonElement : new JsonParser()
  ...
  public static String getCarDetail(Map<String, Integer> map) {
    ...
    for (Entry<String, Integer> entry : map.entrySet()) {
      ...
      sb.append(entry.getKey()).append(entry.getValue()).append("辆");
      i++;
    }
    return sb.toString();
