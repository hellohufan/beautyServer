...
public interface DispatchVehicleHistoryContract {
  ...
  interface Model extends IModel {
    ...
    Observable<BaseRowJson<ApproveOrder>> getApproveOrder(String s, int currentPage,
        int i, String orderBy, String orderCol, String beginCreateTime,
