...
@ActivityScope
public class ApproveUseVehiclePresenter extends
    BasePresenter<ApproveUseVehicleContract.Model, ApproveUseVehicleContract.View> {

  private RxErrorHandler mErrorHandler;

  private ApproveUseVehicleAdapter mAdapter;
  private int currentPage = 1;
  private int totalNum = 0;

  @Inject
  public ApproveUseVehiclePresenter(ApproveUseVehicleContract.Model model,
      ApproveUseVehicleContract.View rootView
      , RxErrorHandler handler, ApproveUseVehicleAdapter adapter) {
