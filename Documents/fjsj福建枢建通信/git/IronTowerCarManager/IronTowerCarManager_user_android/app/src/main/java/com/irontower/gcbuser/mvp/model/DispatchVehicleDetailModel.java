...
@ActivityScope
public class DispatchVehicleDetailModel extends BaseModel implements
    DispatchVehicleDetailContract.Model {

  private Gson mGson;
  private Application mApplication;

  @Inject
  public DispatchVehicleDetailModel(IRepositoryManager repositoryManager, Gson gson,
  ...
  @Override
  public Observable<BaseJson<Object>> finishDispatchCar(String todoId) {
    FormBody formBody = new FormBody.Builder()
        .add("todoId", todoId).build();
    return mRepositoryManager.obtainRetrofitService(CommonService.class)
        .finishDispatchCar(SPUtils.getInstance().getString(
            CommonService.ACCESS_TOKEN), formBody);
  }
