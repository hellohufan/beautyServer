...
@ActivityScope
public class FinishOrderModel extends BaseModel implements FinishOrderContract.Model {

  private Gson mGson;
  private Application mApplication;

  @Inject
  public FinishOrderModel(IRepositoryManager repositoryManager, Gson gson,
