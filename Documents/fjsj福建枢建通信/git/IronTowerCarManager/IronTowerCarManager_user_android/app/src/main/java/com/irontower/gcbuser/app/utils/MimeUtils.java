...
public final class MimeUtils {
  ...
  public static final Map<String, String> mimeTypeToExtensionMap = new HashMap<String, String>();

  public static final Map<String, String> extensionToMimeTypeMap = new HashMap<String, String>();
