...
public interface ApproveGoOutContract {
  ...
  interface Model extends IModel {
    ...
    Observable<BaseRowJson<BegGoOut>> getGoOut(int currentPage, int i);

    Observable<BaseJson<Object>> approvalBegGoOut(String hid, String operDesc, String state);
  }
}
